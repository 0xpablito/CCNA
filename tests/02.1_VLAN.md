...
Ce document regroupe les tests techniques validant la segmentation logique du réseau et la communication inter-VLAN via le cœur de réseau (CORE).


## 📍 Zone Siège (Infrastructure Cœur de Réseau - CORE)
...
* **Points de contrôle :**  Présence de tous les VLANs (10, 20, 30, 40, 99, 999).
